...
// [WARNING] only set up for two drones atm

var drone_spr = sprite_get("hud_drone");

var h1 = sprite_get_height(drone_spr) * clamp((nspec_drone_cd/nspec_drone_cd_max), 0, 1)
...
var h0 = sprite_get_height(drone_spr) * clamp((nspec_drone_cd/nspec_drone_cd_max)-1, 0, 1)
