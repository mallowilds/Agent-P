...
if (has_rune("B")) { // rune B unlocks third drone
    var h2 = sprite_get_height(drone_spr) * clamp((nspec_drone_cd/nspec_drone_cd_max)-nspec_max_drones+3, 0, 1)
...
var h1 = sprite_get_height(drone_spr) * clamp((nspec_drone_cd/nspec_drone_cd_max)-nspec_max_drones+2, 0, 1)
...
var h0 = sprite_get_height(drone_spr) * clamp((nspec_drone_cd/nspec_drone_cd_max)-nspec_max_drones+1, 0, 1)
