...
// FurDark
set_color_profile_slot( 0, 0, 0, 121, 130 );
set_color_profile_slot_range( 0, 1, 1, 1 );

// FurLight
set_color_profile_slot( 0, 1, 26, 153, 162 );
...
// Agent B
set_color_profile_slot( 1, 0, 82, 123, 227 ); //FurDark
set_color_profile_slot( 1, 1, 130, 201, 255 ); //FurLight
...
set_color_profile_slot( 2, 1, 242, 54, 54 ); //FurLight
...
set_color_profile_slot( 3, 1, 137, 140, 47 ); //FurLight
...
set_color_profile_slot( 4, 1, 100, 110, 110 ); //FurLight
...
set_color_profile_slot( 5, 1, 128, 56, 148 ); //FurLight
...
set_color_profile_slot( 6, 1, 167, 186, 74 ); //FurLight
...
set_color_profile_slot( 7, 1, 115, 93, 153 ); //FurLight
...
set_color_profile_slot( 8, 1, 186, 243, 255 ); //FurLight
